...
var _ = Describe("PublicApiHandler", func() {
	...
	JustBeforeEach(func() {
		handler = NewPublicApiHandler(lagertest.NewTestLogger("public_api_handler"), conf, policydb, bindingdb, cred_helper.NewWithPolicyDb(policydb, cred_helper.MaxRetry))
	})
